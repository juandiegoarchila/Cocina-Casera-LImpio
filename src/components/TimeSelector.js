    ...
    <div className="bg-gradient-to-r from-green-50 to-green-100 p-1 xs:p-2 sm:p-3 rounded-lg shadow-sm">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 gap-1 xs:gap-2">
        ...
        <input
          ...
          className="col-span-1 xs:col-span-2 p-1 xs:p-2 text-[10px] xs:text-xs sm:text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-400 placeholder-gray-400 w-full"
